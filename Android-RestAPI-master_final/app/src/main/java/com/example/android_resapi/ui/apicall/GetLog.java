...
public class GetLog extends GetRequest {
    ...
    protected ArrayList<Tag> getArrayListFromJSONString(String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Tag thing = new Tag(jsonObject.getString("CO"),
    ...
    class Tag {
        ...
        public Tag(String co, String led, String motor, String time) {
            CO = co;
            LED = led;
            MOTOR = motor;
            timestamp = time;
        ...
        public String toString() {
            return String.format("[%s] CO: %s, LED: %s, MOTOR: %s", timestamp, CO, LED, MOTOR);
        }
    }
}
